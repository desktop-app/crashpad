...
option(CRASHPAD_ARCH_ARMV7_USE_NEON "Use NEON SIMD instructions when building for ARMv7" ON)
...
if ((HAVE_ARM_DEF1 OR HAVE_ARM_DEF2) OR HAVE_ARM_DEF3)
    ...
    if (((HAVE_ARMV7_DEF1 OR HAVE_ARMV7_DEF2) OR (HAVE_ARMV7_DEF3 OR HAVE_ARMV7_DEF4)) OR
        ...
        #
        if (CRASHPAD_ARCH_ARMV7_USE_NEON)
            message(STATUS "NEON SIMD instructions enabled (can be disabled with -DCRASHPAD_ARCH_ARMV7_USE_NEON=OFF).")
            set(arm_use_neon 1)
            ...
            message(STATUS "NEON SIMD instructions not used (can be enabled with -DCRASHPAD_ARCH_ARMV7_USE_NEON=ON).")
        endif()
    else()
